...
import RecetaProvider, {RecetaContext} from "../contexts/Receta&CategoryContext"
import IngredientProvider from "../contexts/Ing&StepContext";
...
export default function RecetaDetail() {
    ...
    const receta = recipes.find((recipe) => recipe.id === parseInt(id));
                        ...
                        <div className=" is-flex is-justify-content-flex-end is-align-items-flex-end">
                            ...
                            {isModalOpen ? (
                                <DeleteRecetaModal
                                    ...
                                    receta_id={id}
                                    onDelete={{ receta, isLoading, isError }}
                                />
                            ) : null}
                        </div>
